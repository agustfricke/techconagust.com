...
const Video = ({ match }) => {
    ...
    useEffect(() => {
        document.title = 'Tech con Agust | Capitulo '
    }, []);
                                                            ...
                                                            {curso.episodios && curso.episodios.map((epi) => (
                                                                <li className='mt-1'>
                                                                    <a href={`/video/${epi.id}/${curso.id}`}>
                                                                        <div className='flex space-x-2 items-center px-5 transition-colors  text-white hover:text-grey-3 bg-grey-2 hover:bg-grey font-bold font-mono  p-2  rounded-lg'>
                                                                            <img className='w-12 h-12 rounded-full mr-4' src={`${URL}${epi.file}`} />
                                                                            <span className=' '>
                                                                                {epi.title}
                                                                            </span>
                                                                        </div>
