...
export default function BreadCrumbs() {
  ...
  return (
    <div className="mb-4 flex items-center gap-2 px-4 text-sm">
      <a
        href="/"
        className="rounded-lg border bg-gris-200/50 p-1 hover:bg-gris-200/75 hover:no-underline dark:border-gris-200/20 dark:bg-gris-200/10 dark:hover:border-gris-200/50"
      >
